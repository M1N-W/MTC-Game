...
**คำสั่ง Windsurf:** _"commit and push, check changes first, write detailed description, update @sw.js, @CHANGELOG.md, @PROJECT_OVERVIEW.md"_
...
- **Documentation:** Removed all references to `README-info.md` (file no longer in project).
- **Updated files:** PROJECT_OVERVIEW.md (File Structure table, version bump list, Commit workflow), .cursor/commands/commit-push.md, .cursor/rules/version-bump.mdc, mtc-game-conventions.md (§15), .windsurfrules (version bump steps, doc list, commit examples).
- **Version bump workflow:** Version is now synced only across sw.js, CHANGELOG.md, and PROJECT_OVERVIEW.md.

### [NEXT VERSION] — March 11, 2026 (previous)
...
_(Archived changes removed for brevity - see git history for full record)_
