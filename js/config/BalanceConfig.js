...
const BALANCE = {
    ...
    characters: {
        ...
        auto: {
            ...
            passiveHeatGainBonus: 1.20,
            passiveHeatNoDecayOnMove: false,
            vacuumEarlyUnlock: true,
            rageModeHpThreshold: 0.30,
            rageDamageMult: 1.30,
            rageDamageReduction: 0.20,
            speedOnHit: 15,
    ...
    enemy: {
        ...
        chaseRange: 150,
        projectileSpeed: 500,
        baseHp: 40, hpPerWave: 0.19,
        baseSpeed: 85, speedPerWave: 6,
        baseDamage: 8, damagePerWave: 1.4,
    ...
    tank: {
        ...
        expValue: 45,
        powerupDropMult: 1.5,
        baseHp: 100, hpPerWave: 0.20,
        baseSpeed: 60, speedPerWave: 3,
        baseDamage: 18, damagePerWave: 2.5,
        meleeRange: 55
    },
    mage: {
        radius: 16,
    ...
    boss: {
        ...
        phase2Speed: 190,
        phase2Threshold: 0.5,
        phase2ThresholdByEnc: [null, 0.50, null, 0.60, null, 0.65],
