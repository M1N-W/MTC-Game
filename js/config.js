...
const BALANCE = {
    ...
    characters: {
        ...
        // ────────────────────────────────
        // KAO — นักเรียน MTC สายซุ่ม (ตัวละครดั้งเดิม)
        // ────────────────────────────────
        kao: {
            name: 'Kao',
    ...
    powerups: {
        ...
        dropRate: 0.15, // Chance for an enemy to drop a power-up
        lifetime: 14, // Time before power-up disappears if not picked up
        healAmount: 35,
        damageBoost: 1.5,
