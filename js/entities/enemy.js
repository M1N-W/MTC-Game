 ...
 * Enemy runtime classes and registry definitions.
 * EnemyRenderer now lives in js/rendering/EnemyRenderer.js and loads after this file.
 */
// โ”€โ”€โ”€ Tunable: seconds a hit-flash stays at full opacity before fading out โ”€โ”€โ”€
// At 0.10 s (โ 6 frames @ 60 fps) the flash is snappy but legible.
const HIT_FLASH_DURATION = 0.1;

// โ”€โ”€โ”€ Tunable: enemy contact damage multiplier during a Glitch Wave โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
// 0.6 = 40 % reduction. Applies only to melee contact (not projectiles).
const GLITCH_DAMAGE_MULT = 0.6;

// โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•
// ENEMY BASE โ€” shared foundation for all enemy types
// โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•
// Inherit from this (not Entity) when creating new enemy classes.
// Provides automatically:
//   โ€ข Unique ID               (this.id)
//   โ€ข StatusEffect framework  (addStatus / removeStatus / getStatus / tickStatuses)
//   โ€ข UtilityAI               (this._ai, this._aiMoveX, this._aiMoveY)
//   โ€ข Hit-flash state         (this.hitFlashTimer)
//   โ€ข Sticky-slow state       (this.stickyStacks, this.stickySlowMultiplier)
//
...
// โ”€โ”€ Phase 2: Unique enemy ID counter for sticky stack tracking โ”€โ”€
...
class EnemyBase extends Entity {
   ...
   * @param {number} y
   * @param {number} radius
   * @param {string} personalityType โ€” 'basic' | 'tank' | 'mage' (for UtilityAI)
   */
  constructor(x, y, radius, personalityType) {
    super(x, y, radius);

    // Unique ID โ€” never reused within a session
    this.id = ++_enemyIdCounter;

    // โ”€โ”€ Hit flash โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
    this.health = new HealthComponent(100, HIT_FLASH_DURATION);
    // Proxy getters โ€” call sites เน€เธ”เธดเธก (this.hp, this.dead) เธ—เธณเธเธฒเธเธเธเธ•เธด

    // โ”€โ”€ Sticky slow โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
    this.stickyStacks = 0;
    this.stickySlowMultiplier = 1;

    // โ”€โ”€ StatusEffect Framework โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
    this.statusEffects = new Map();
    this._statusToRemove = [];

    // โ”€โ”€ UtilityAI โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
    ...
    this._ai =
      typeof UtilityAI !== "undefined"
        ...
        : null;
    // AI movement override โ€” written by UtilityAI, read in subclass update()
  ...
  // โ”€โ”€ Proxy getters โ€” keep call sites backward-compatible โ”€โ”€
  ...
  // _tickShared โ€” call at top of every subclass update()
  ...
  _tickShared(dt, player) {
    ...
    // โ”€โ”€ Elemental Reaction: IGNITE + SLOW โ’ SHATTER โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
    // Triggers when ignited enemy is also significantly slowed (sticky โฅ3 stacks
    // OR PhysicsFormulaZone slow detected via stickySlowMultiplier < 0.65).
    // One reaction per ignite application โ€” flag _shatterUsed prevents repeat.
    if ((this.igniteTimer ?? 0) > 0 && !this._shatterUsed) {
      ...
      if (isSlowed) {
        ...
        const shatterDmg = (this.igniteDPS ?? 12) * 2.5; // 2.5ร— ignite DPS as burst
        this.takeDamage(shatterDmg);
        this.igniteTimer = 0; // consume ignite
        this.igniteDPS = 0;
        // Brief stun โ€” write AI stun directly (safe per architecture rules)
        this._shatterStunTimer = 0.4;
        if (typeof spawnFloatingText === 'function')
          spawnFloatingText('๐’ฅ SHATTER!', this.x, this.y - 50, '#f0abfc', 22);
    ...
    // โ”€โ”€ Shatter stun tick โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
  ...
  addStatus(type, data) {
    ...
    // Convert legacy expireAt (absolute timestamp) โ’ remaining (seconds)
    const incoming =
  ...
  // โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
  // Base takeDamage โ€” triggers hit flash, disposes AI on death
  // Subclasses call super.takeDamage(amt, player) or override fully
  // โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
  takeDamage(amt, player) {
    // Wire _onDeathCb once (cheap โ€” same reference check)
...
class Enemy extends EnemyBase {
  ...
  update(dt, player) {
    ...
    // โ”€โ”€ Shared: StatusEffects + hitFlash + ignite + AI tick โ”€โ”€
    ...
    this.angle = Math.atan2(dy, dx);
    // โ”€โ”€ VacuumHeat AI-lock: skip vx/vy override while being pulled โ”€โ”€
    if ((this.vacuumStunTimer ?? 0) > 0) {
      this.vacuumStunTimer -= dt;
      if ((this._vacuumPullTimer ?? 0) > 0) {
        this._vacuumPullTimer -= dt;
    ...
    if (
      ...
      const _leadT = Math.min(0.08 + (_wave - 1) * 0.015, 0.25); // 0.08sโ’0.25s by wave12
      ...
      projectileManager.add(
        new Projectile(
          this.x,
          this.y,
          Math.atan2(_aimY - this.y, _aimX - this.x),  // โ predictive angle
    ...
    // โ”€โ”€ Melee contact damage โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
  ...
  _onDeath(player) {
    ...
    // โจ [bullet_time_kill] เธเธฑเธเธเธดเธฅเธเธ“เธฐ Slow-mo
  ...
  // draw() โ’ EnemyRenderer.drawBasic()
}

// โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•
// TANK ENEMY โ€” heavy melee bruiser, SquadAI role: SHIELD
// โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•
class TankEnemy extends EnemyBase {
  ...
  // draw() โ’ EnemyRenderer.drawTank()
}

// โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•
// MAGE ENEMY โ€” ranged caster, SquadAI role: SUPPORT
...
class MageEnemy extends EnemyBase {
  ...
  update(dt, player) {
    ...
    if ((this.vacuumStunTimer ?? 0) > 0) {
      ...
      // Mage: AI steering 25% โ€” orbit logic takes priority
    ...
    if (this.meteorCD <= 0 && Math.random() < 0.005 * dt * 60) {
      // Lead time scales with wave: 0.15s (wave1) โ’ 0.40s (wave10+)
      ...
      const _spread = Math.max(120, 300 - (_wave - 1) * 18);       // 300โ’120 by wave 11
...
class PowerUp {
  constructor(x, y) {
    ...
    this.icons = { heal: "โค๏ธ", damage: "โก", speed: "๐€" };
  ...
  // draw() moved to EnemyRenderer.drawXxx() โ€” see bottom of this file.
}
// โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•
// ๐ WINDOW EXPORTS
// โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•
