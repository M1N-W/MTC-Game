const CACHE_NAME = 'mtc-cache-v3.4.0'; // v3.4.0 Critical Bug Fixes: DOM access guards, RAF race condition fix, memory leak cleanup, null checks, canvas validation, AI timeout
