const CACHE_NAME = 'mtc-cache-v3.19.0'; // v3.19.0: Removed Gemini AI dependency - switched to local text-based system for mission names, boss taunts, and report cards
