const CACHE_NAME = 'mtc-cache-v2.57'; // ⚠️ เปลี่ยนเลขเวอร์ชันตรงนี้ทุกครั้งที่มีการอัปเดตเกม, v2.56 Admin Authentication System — secret keylogger, Dev Mode panel, AdminConsole access gate, remove persistent passive from save
