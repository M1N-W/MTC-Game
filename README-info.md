...
> **Current Version:** Beta v3.29.9 | **Latest Update:** Global Variable References & Voice Bubble Namespacing Fix - Fixed showVoiceBubble() calls to use window.UIManager prefix and corrected boss class references
