...
- Angle update rule (established v3.40.x):
  ...
  ✅ team === 'enemy': this.angle += dt _ spinRate; // spinning glyph effect
  ❌ this.angle += dt _ constant; // for ALL teams — player bullets visually skew over distance
