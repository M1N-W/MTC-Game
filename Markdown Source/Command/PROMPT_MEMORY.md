...
## 🎯 ส่วนที่ 7: AI Tool Selection Guide (Trae IDE vs Claude Website)

### คำแนะนำ: เมื่อไหร่ควรใช้เครื่องมือไหน?

| สถานการณ์ | เครื่องมือที่แนะนำ | เหตุผล |
| :--- | :--- | :--- |
| **พัฒนาฟีเจอร์, แก้บั๊ก, Refactor** | **Trae IDE (Agent Mode)** | **Primary:** เข้าถึงไฟล์ได้โดยตรง, เห็นบริบททั้งโปรเจกต์, รัน Terminal และรัน Test ได้ทันที |
| **ออกแบบเนื้อเรื่อง, คิดไอเดียบอสใหม่** | **Claude (Website)** | **Secondary:** เหมาะสำหรับการระดมสมอง (Brainstorming) และใช้ Artifacts จำลองไอเดียเบื้องต้น |
